...
#define TAG "AskforV2Board"

LV_FONT_DECLARE(font_puhui_14_1);
LV_FONT_DECLARE(font_awesome_14_1);

class AskforV2Board : public WifiBoard {
private:
...
public:
  AskforV2Board()
    ...
    gpio_set_direction(VOLUME_UP_BUTTON_GPIO, GPIO_MODE_INPUT);
    gpio_set_direction(VOLUME_DOWN_BUTTON_GPIO, GPIO_MODE_INPUT);
...
public:
  PressToTalk()
    ...
    properties_.AddBooleanProperty(
        ...
        []() -> bool {
          auto board = static_cast<AskforV2Board *>(&Board::GetInstance());
